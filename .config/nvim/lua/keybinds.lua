...
-- ║  Visits/Bookmarks  ║
-- ╚════════════════════╝
keymap("n", "<leader>vl", function() require('mini.visits').add_label() end,
{ desc = 'Add Label' })
keymap("n", "<leader>vp", function() require('mini.extra').pickers.visit_paths() end,
{ desc = 'Show Latest Paths' })
keymap("n", "<leader>vs", function() require('mini.extra').pickers.visit_labels() end,
{ desc = 'Show Saved Labels' })
...
keymap("n", "<q>", "<cmd>noh<cr>", { desc = 'Clear Search' })
